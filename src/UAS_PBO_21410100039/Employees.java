...
public class Employees extends javax.swing.JFrame {
    ...
    String headerTable[] = {"ID", "NAMA LENGKAP", "JABATAN", "STATUS", "TANGGAL BEKERJA"};
...
//        id.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DASHBOARD EMPLOYEE RUMAH SAKIT HUSADA");
        ...
        controlFormUpdate.setEnabled(false);
        ...
        controlFormNew.setEnabled(false);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (!chooser) {
            ...
            String status = table.getValueAt(baris, 3).toString();
